      ...
      <SectionContainer className="text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6 md:gap-8 max-w-5xl mx-auto opacity-80">
          {ICONS_LIST.map((Item, idx) => (
            <div 
              key={idx} 
              className="w-16 h-16 md:w-20 md:h-20 bg-white rounded-2xl shadow-lg border border-gray-100 flex items-center justify-center transform hover:-translate-y-2 transition-transform duration-300"
              style={{
